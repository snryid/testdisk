use testdisk_core::{
    ...
    recover_fat_deleted_files, scan_disk, scan_report_json, BootSectorDiagnosis,
    BootSectorRepairPlan, CarvingJobTranscript, FormatDiskRequest, FormatDiskResult,
    FormatFilesystemOption, ImagingTranscript, RecoveryJobTranscript, ScanResult,
};
use testdisk_platform::{
    format_disk, format_filesystem_options, host_platform_adapter, DiskInfo, PlatformAdapter,
};
...
#[tauri::command]
fn preview_format_plan_command(
    request: FormatDiskRequest,
) -> Result<testdisk_core::FormatOperationPlan, String> {
...
#[tauri::command]
fn recover_deleted_files(
    source_path: String,
    destination_dir: String,
) -> Result<RecoveryJobTranscript, String> {
